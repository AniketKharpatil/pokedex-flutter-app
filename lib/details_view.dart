                        ...
                        child: Card(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(details.name,style: TextStyle(fontFamily: 'RobotoMono',fontSize: 26,fontWeight: FontWeight.bold),),
                              Row(
                              ...
                              Text(
                                  'ID: ${details.id}  -  Weight: ${details.weight}  -  Height: ${details.height}',style: TextStyle(fontSize: 20),)
                            ],
                          ),
                        )),
                    Expanded(
